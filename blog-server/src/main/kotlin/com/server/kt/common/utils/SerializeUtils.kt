...
object SerializeUtils {
    ...
    @Throws(IOException::class)
    fun hessianDeserialize(input: InputStream): Any = HessianInput(input).readObject()
    ...
    @Throws(IOException::class)
    fun hessianSerialize(obj: Any, out: OutputStream) = HessianOutput(out).writeObject(obj)
